(function($){
	...
	window[fnName] = function(magnifierAttr){
		...
		_this.eqImg = function(){
			...
			_this.thumbnail.find('>*').removeClass('listimgcenAc').eq(magnifier.index).addClass('listimgcenAc');
...
//				multiple = magnifier.width / boxMoveViewWidth
				...
				viewWidth = boxMoveViewWidth*multiple;
		...
		_this.moveFn = function(e){
			...
			var X = (e.clientX-_this.magnifier.offset().left)-boxMoveViewWidth/2-100,
